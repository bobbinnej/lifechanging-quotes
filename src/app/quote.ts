export class Quote {
    ...
    */
    ...
    constructor(public description:string, public author:string, public submitter:string, public uvotes:number, public dvotes:number, public datePublished:Date ){
